    ...
    <div class="row">
      <div class="col s4">
        <input
          v-model="search"
          type="text"
          :placeholder="'Message_EnterName' | localize"
        >
      </div>
      <div class="col s12">
        <table class="highlight">
          <thead>
            <tr>
              ...
              <th />
              <th />
              <th @click="sortBy = 'name'; toggleSortDirection()">
                <a class="waves-effect waves-orange pointer">{{
                  'Student' | localize
                }}</a>
              </th>
              <th @click="sortBy = 'idCard'; toggleSortDirection()">
                <a class="waves-effect waves-orange pointer">{{
                  'idCard' | localize
                }}</a>
              </th>
              <th @click="sortBy = 'birthDate'; toggleSortDirection()">
                <a class="waves-effect waves-orange pointer">{{
                  'Date_of_birth' |
                    localize
                }}</a>
              </th>
              <th @click="sortBy = 'gender'; toggleSortDirection() ">
                <a class="waves-effect waves-orange pointer">{{
                  'Gender' | localize
                }}</a>
              </th>
              <th @click="sortBy = 'maritalStatus'; toggleSortDirection() ">
                <a
              ...
              <th @click="sortBy = 'height'; toggleSortDirection()">
                <a class="waves-effect waves-orange pointer">{{
                  'Height' | localize
                }}</a>
              </th>
              <th @click="sortBy = 'weight'; toggleSortDirection()">
                <a class="waves-effect waves-orange pointer">{{
                  'Weight' | localize
                }}</a>
              </th>
              <th @click="sortBy = 'colorBelt'; toggleSortDirection()">
                <a class="waves-effect waves-orange pointer">{{
                  'Color_Belt' | localize
                }}</a>
              </th>
              <th @click="sortBy = 'tel'; toggleSortDirection()">
                <a class="waves-effect waves-orange pointer">Tel.</a>
              </th>
              <th @click="sortBy = 'email'; toggleSortDirection()">
                <a
                  class="waves-effect waves-orange pointer"
                >Email</a>
              </th>
              <th @click="sortBy = 'dateContract'; toggleSortDirection()">
                <a
                  class="waves-effect waves-orange pointer"
                >{{
                  'Date_Contract' |
              ...
              <th @click="sortBy = 'monthlyPayment'; toggleSortDirection()">
                <a
                  class="waves-effect waves-orange pointer"
                >{{
                  'Monthly_Payment' |
              ...
              <th @click="sortBy = 'dateNextPayment'; toggleSortDirection()">
                <a
                  class="waves-effect waves-orange pointer"
                >{{
              ...
              <th @click="sortBy = 'amountFine'; toggleSortDirection()">
                <a class="waves-effect waves-orange pointer">{{
                  'Amount_of_fine' |
                    localize
                }}</a>
          ...
          <tbody>
            <tr
              v-for="students of filteredStudents"
              :key="students.id"
            >
              <td>
                <button
