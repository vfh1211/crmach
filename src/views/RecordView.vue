<template>
  <div>
    ...
    <section>
      ...
      <div class="row">
        <div class="col s6">
          <TuitionFees :info-student-id="selectedStudentId" />
        </div>
        <div
          class="col s6"
          offset-s6
          ...
          <table class="highlight">
            <thead>
              <tr>
                <th />
                <th
                  :class="{ 'sort-active': sortBy === 'student' }"
                  @click="sortedPayments('student')"
                >
                  <a
                ...
                <th
                  ...
                  @click="sortedPayments('date')"
                >
                  <a
                    class="waves-effect waves-orange pointer"
                  >{{ 'Date_payment' | localize }}</a>
                </th>
                <th />
              </tr>
            </thead>
            ...
            <tbody>
              <tr
                v-for="students of students"
                :key="students.id"
                :class="{ 'table-row-selected': students.selected }"
              >
                <td>
                  <button
